...
Connect a LinkedIn profile so the [Social](/apps/social) app can publish posts as you.

This covers **Social publishing** for the connected member profile. It is not a messaging adapter.
...
4. Use [Social](/apps/social) to draft or schedule posts as that profile

The same LinkedIn connection can be reused by Social and other features such as metrics.

## How it works

- Social posts publish through the connected member access token when a post is due
