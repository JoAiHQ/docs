...
Connect an X account so mentioning your agent can ingest posts into JoAi knowledge, and so the [Social Media](/apps/social) app can publish posts as you.

This covers **mention ingest** and **Social Media publishing**. It is not a full chat adapter like Telegram or Slack.
...
4. Use [Social Media](/apps/social) to draft or schedule posts as that linked account

The same X connection can be reused by Social Media and other features such as metrics.
...
- Social Media posts publish through the same linked X account when a post is due
