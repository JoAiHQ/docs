...
Connect a Facebook Page so the [Social](/apps/social) app can publish posts as that Page.

This covers **Social publishing** for a Page you manage. It is not a Messenger chat adapter.
...
4. Use [Social](/apps/social) to draft or schedule posts as that Page

JoAi stores the first Page returned for the connected account. Reconnect if you need to switch Pages. The same Page connection can be reused by Social and other features such as metrics.

## How it works

- Social posts publish through the connected Page access token when a post is due
