...
| --- | --- | --- | --- |
| **Email** | Subject + body | Static + AI | — |
| **WhatsApp** | Template body | Static only | Slug-style name, language, category, approval before send |
| **SMS** | Body | Static + AI | — |
| **Push** | Title + body | Static + AI | — |

AI placeholders (`aiParams`) require an **agent** on the campaign with an **active integration** for that channel. Delivery itself also runs through the team's messaging setup for the channel.
